...
class ArticleDbAdapter (val context: Context, val artcileList : MutableList<ArticleDB>, val showArticle : (article : ArticleDB)-> Unit ) : RecyclerView.Adapter<ArticleDbAdapter.ViewHolder>() {
